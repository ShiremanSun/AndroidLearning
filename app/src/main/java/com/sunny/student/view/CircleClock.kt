...
import com.sunny.student.getBottomY
import com.sunny.student.getCenterY
import com.sunny.student.getTopY
import com.sunny.student.toText
import java.util.*
    ...
    private fun drawSecond(canvas: Canvas, degree : Float) {
        ...
        for (i in 0..59) {
            ...
            if (i != 0) {
                ...
                canvas.drawText("零秒", mSecondR, mPaint.getCenterY(), mPaint)
            }
            canvas.restore()
        }
        canvas.restore()
    ...
    private fun drawMinute(canvas: Canvas, degree : Float) {
        ...
        for (i in 0..59) {
            ...
            if(i != 0) {
                ...
                canvas.drawText("零分", mMinuteR, mPaint.getCenterY(), mPaint)
            }
            canvas.restore()
        }
        canvas.restore()
