...
import com.sunny.student.databinding.FragmentConversationBinding
...
class ConversationFragment : Fragment() {
    ...
    private var keyboardObserverPopupWindow: KeyboardObserverPopupWindow? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        keyboardObserverPopupWindow = KeyboardObserverPopupWindow(requireContext(), binding.messageEdittext) { visible, height ->
            binding.root.setPadding(0, 0, 0, height)
        }
        // There are three steps to WindowInsetsAnimations:
        keyboardObserverPopupWindow?.show()
        binding.messageEdittext.requestFocus()
        KeyBoardUtil.showSoftKeyBoard(requireContext(), binding.messageEdittext)
