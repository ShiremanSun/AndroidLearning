...
class RootViewDeferringInsetsCallback(
    ...
    override fun onApplyWindowInsets(
        ...
        v.setPadding(typeInsets.left + originPadding.left, originPadding.top + typeInsets.top, typeInsets.right + originPadding.right, typeInsets.bottom + originPadding.bottom)
