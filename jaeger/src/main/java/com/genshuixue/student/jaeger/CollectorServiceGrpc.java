...
final class CollectorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.genshuixue.student.jaeger.Collector.PostSpansRequest,
      com.genshuixue.student.jaeger.Collector.PostSpansResponse> getPostSpansMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PostSpans",
      requestType = com.genshuixue.student.jaeger.Collector.PostSpansRequest.class,
      responseType = com.genshuixue.student.jaeger.Collector.PostSpansResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.genshuixue.student.jaeger.Collector.PostSpansRequest,
      com.genshuixue.student.jaeger.Collector.PostSpansResponse> getPostSpansMethod() {
    io.grpc.MethodDescriptor<com.genshuixue.student.jaeger.Collector.PostSpansRequest, com.genshuixue.student.jaeger.Collector.PostSpansResponse> getPostSpansMethod;
      ...
      synchronized (CollectorServiceGrpc.class) {
        if ((getPostSpansMethod = CollectorServiceGrpc.getPostSpansMethod) == null) {
          CollectorServiceGrpc.getPostSpansMethod = getPostSpansMethod =
              io.grpc.MethodDescriptor.<com.genshuixue.student.jaeger.Collector.PostSpansRequest, com.genshuixue.student.jaeger.Collector.PostSpansResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PostSpans"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.genshuixue.student.jaeger.Collector.PostSpansRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.genshuixue.student.jaeger.Collector.PostSpansResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class CollectorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void postSpans(com.genshuixue.student.jaeger.Collector.PostSpansRequest request,
        io.grpc.stub.StreamObserver<com.genshuixue.student.jaeger.Collector.PostSpansResponse> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.genshuixue.student.jaeger.Collector.PostSpansRequest,
                com.genshuixue.student.jaeger.Collector.PostSpansResponse>(
  ...
  public static final class CollectorServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CollectorServiceBlockingStub> {
    ...
    /**
     */
    public com.genshuixue.student.jaeger.Collector.PostSpansResponse postSpans(com.genshuixue.student.jaeger.Collector.PostSpansRequest request) {
  ...
  public static final class CollectorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CollectorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.genshuixue.student.jaeger.Collector.PostSpansResponse> postSpans(
        com.genshuixue.student.jaeger.Collector.PostSpansRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POST_SPANS:
          serviceImpl.postSpans((com.genshuixue.student.jaeger.Collector.PostSpansRequest) request,
              (io.grpc.stub.StreamObserver<com.genshuixue.student.jaeger.Collector.PostSpansResponse>) responseObserver);
          break;
        default:
